...
import { VictoryGroup, VictoryArea, VictoryChart, VictoryLegend, VictoryAxis } from 'victory'
    ...
    return (
      ...
      >
        ...
        <VictoryLegend
          ...
          data={[
            { name: "PM2.5", symbol: { fill: "#02A27F" } }, 
            { name: "PM10", symbol: { fill: "#FF595E" } }, 
            { name: "Pedestrian", symbol: { fill: "#FFCA3A" } }, 
            { name: "Bicycle", symbol: { fill: "#E66337" } }, 
            { name: "Others", symbol: { fill: "#5E50B5" } }
          ]}
        />
      </VictoryChart>
    )
